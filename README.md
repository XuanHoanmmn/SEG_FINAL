...
**Phase 5 — BM25F, phrase/proximity and structured filters**
...
1. Xây ground truth và so sánh TF-IDF/BM25F bằng P@10, MAP, MRR và nDCG.
2. Thêm API, snippets/highlights và pagination sau khi evaluation ổn định.
